...
def main():
    ...
    train_loader, train_sampler = get_distributed_dataloader(
        dataset=train_set,
    ...
    args.clip_grad_norm = (
        ...
        else args.clip_grad_norm
    )
    if args.lr is None:
        print(
            "User defined learning rate not available, defaulting to the learning rate in corresponding config file."
        )
    learning_rate = (
        args.lr
